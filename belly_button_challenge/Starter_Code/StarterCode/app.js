...
//create bar chart
 function updateBarChart(sample1, otuId1, otuLabel1) {
    let trace1 = {
        x: sample1,
...
//define layout and show plot
    ...
    if (barPlot) {
        Plotly.react("bar", trace1, layout1);
}       else {
            barPlot = Plotly.newPlot("bar", trace1, layout1);
}
};

updateBarChart(sample1, otuId1, otuLabel1);
